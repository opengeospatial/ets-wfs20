...
public class VerifyAppSchemaUtils {
	...
	public void findSimpleProperties_integerType() {
		String[] integerProperties = { "byteProperty", "intProperty2", "longProperty", "negativeIntegerProperty",
				"nonNegativeIntegerProperty", "nonPositiveIntegerProperty", "positiveIntegerProperty", "shortProperty",
				"unsignedLongProperty", "unsignedIntProperty", "unsingedShortProperty", "unsignedByteProperty" };
