...
public class VerifyXMLUtils {
    ...
    @Test
    public void transformGMLEnvelopeToPolygon() throws SAXException,
            IOException {
        Document source = docBuilder.parse(this.getClass().getResourceAsStream(
                "/Envelope.xml"));
        ...
        String posList = result
                .getElementsByTagNameNS(Namespaces.GML, "posList").item(0)
                .getTextContent();
        Assert.assertTrue(
                "Expected gml:posList to end with coord '49.0 -124.0'",
                posList.endsWith("49.0 -124.0"));
    }
    ...
    public void writeNodeToString_Latin1Char() throws SAXException, IOException {
        ...
        Assert.assertTrue("Expected result to contain 'Montréal'",
