...
public class VerifyServiceMetadataUtils {
	...
	@Test
	public void findDescribeFeatureTypeUsingGETPreserveQuery() throws SAXException, IOException {
	...
	@Test
	public void findDescribeFeatureTypeUsingGETRemoveTrailingQuestionMark() throws SAXException, IOException {
		File xmlFile = new File("src/test/resources/capabilities-querystring.xml");
		URI endpoint = ServiceMetadataUtils.getOperationEndpoint(docBuilder.parse(xmlFile), WFS2.LIST_STORED_QUERIES,
				ProtocolBinding.GET);
		assertEquals("Unexpected endpoint for DescribeFeatureType(GET)", "http://localhost/wfs2", endpoint.toString());
	}
