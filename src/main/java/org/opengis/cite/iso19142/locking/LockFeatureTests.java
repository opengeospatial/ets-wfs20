...
public class LockFeatureTests extends LockingFixture {
     ...
     * 
     * <p>
     * <strong>Note</strong>: The error code {@code InvalidLockId} would seem
     ...
     */
    @Test(description = "urn:iso:std:iso:19142:clause:12.2.4.2")
     ...
     * </ul>
     */
    @Test(description = "urn:iso:std:iso:19142:clause:12.2.4.3,15.2.3.1.2")
     ...
     * </ul>
     */
    @Test(description = "urn:iso:std:iso:19142:clause:12.2.3,12.2.5")
     ...
     */
    @Test(description = "urn:iso:std:iso:19142:clause:12.3.2", dataProvider = "protocol-featureType")
